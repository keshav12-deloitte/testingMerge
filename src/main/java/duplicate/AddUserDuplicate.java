...
//    }
//
//    public String adminAddingManager() throws InterruptedException, IOException {
//        Thread.sleep(3000);
//        WebElement userProfileBtn = driver.findElement(addUserprofileBtn);
...
//    }
//
//    public String adminAddingEmployee() throws InterruptedException, IOException {
//
//        //Thread.sleep(3000);
//        WebElement userProfileBtn = driver.findElement(addUserprofileBtn);
//        userProfileBtn.click();
...
//        employee.click();
//        new WebDriverWait(driver, 10).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[contains(text(),'keshav')]")));
//        String employeename = driver.findElement(By.xpath("//div[contains(text(),'keshav')]")).getText();
...
//        manager.click();
//        new WebDriverWait(driver, 10).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[contains(text(),'ramesh')]")));
//        String managername = driver.findElement(By.xpath("//div[contains(text(),'ramesh')]")).getText();
//        return managername;
//    }
}
