...
public class EmployeePageDuplicate {
    WebDriver driver;
...
//    By removeProfileloc=By.xpath("//ul[@class='profile-social-links']/child::li[2]/child::a[@href='mailto:keshavchander100@gmail.com']/parent::*/parent::*/following-sibling::button");
